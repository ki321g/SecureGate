        ...
        try {
            ...
            if (response.data) {
                ...
                if (response.data.status === 'success') {
                    ...
                    // console.log('After setIsReading');

                    // try {
                    //     console.log('Before usersApi.getByCardId');
                        
                    //     console.log('HERE HERE card_id :', cardData.card_uid)
                    //     const { data, error } = await usersApi.getByCardId(cardData.card_uid)
                    //     console.log('After usersApi.getByCardId');
